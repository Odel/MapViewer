...
public class ClutterSprite extends Graphics2D
{
    ...
    public ClutterSprite(DatFile e, String s, int i)  //loads tree and rock sprites?
    {
        IoBuffer j = new IoBuffer(e.loadNestedDat(s + ".dat", null));
        IoBuffer k = new IoBuffer(e.loadNestedDat("index.dat", null));
