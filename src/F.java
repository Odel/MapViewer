...
public class F extends Graphics2D
{
    ...
    public F(DatFile e, String s, boolean flag)
    {
    	//System.out.println(s);
        append = new byte[256][];
        charAt = new int[256];
        ...
        B = new Random();
        D = false;
        IoBuffer buffer = new IoBuffer(e.loadNestedDat((new StringBuilder()).append(s).append(IResourceLoader.I(1251)).toString(), null));
        IoBuffer j = new IoBuffer(e.loadNestedDat(IResourceLoader.I(1256), null));
